...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
			...
			<div id="MenuNavegacion" class="collapse navbar-collapse">
				<ul class="navbar-nav ms-3">
					<li class="nav-item">
                        <a class="nav-link active" href="/confirmarcompra">agregar</a>
                    </li>
          <li class="nav-item">
  ...
  <div class="card-body">
    ...
    <button type="button"  class="btn btn-primary  "><a id="boton" href="/">Cancelar Compra</a></button><br><br>
    <button type="button" class="btn btn-primary  "><a id="boton" href="/">Ver otros Libros</a></button>
...
<br>
  ...
  <br><div class="row">
    <div class="col-sm-3">
    <button type="submit" class="btn btn-primary"><a id="boton" href="/">Confirmar Compra</a></button>
  </div>
</form>
